...
public class ColorChooserDialog extends DialogFragment implements View.OnClickListener, View.OnLongClickListener {
    ...
    private class ColorGridAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = new CircleView(getActivity());
    ...
    public static class Builder implements Serializable {
        ...
        @NonNull
        protected final transient Activity mContext;
        @StringRes
        ...
        public <ActivityType extends Activity & ColorCallback> Builder(@NonNull ActivityType context, @StringRes int title) {
            mContext = context;
            mTitle = title;
        }
        ...
        public ColorChooserDialog show() {
            ...
            dialog.show((AppCompatActivity)mContext);
            return dialog;
        }
    }
