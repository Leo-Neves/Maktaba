...
import com.leoneves.maktaba.fabreveal.reveal.RevealAnimator;
import com.leoneves.maktaba.fabreveal.reveal.SupportAnimator;
import com.leoneves.maktaba.fabreveal.reveal.ViewAnimationUtils;

/**
 * Created by leo on 09/02/18.
 */

public class FabRevealContainer extends LinearLayout implements RevealAnimator {
    ...
    public FabRevealContainer(Context context) {
        this(context, null);
    }

    public FabRevealContainer(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FabRevealContainer(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
