package com.leoneves.maktaba.fabreveal.fabanimations;
...
import com.leoneves.maktaba.fabreveal.reveal.SupportAnimator;
...
public class MaterialSheetAnimation {
    ...
    private FabRevealFactory.RevealXDirection revealXDirection;
    private FabRevealFactory.RevealYDirection revealYDirection;
    ...
    public MaterialSheetAnimation(View sheet, int sheetColor, int fabColor,
        ...
        revealXDirection = FabRevealFactory.RevealXDirection.LEFT;
        revealYDirection = FabRevealFactory.RevealYDirection.UP;
    ...
    public void alignSheetWithFab(View fab) {
        ...
        if (rightDiff != 0) {
            ...
            // Otherwise, align the left side of the sheet with the left side of the FAB
                ...
                revealXDirection = FabRevealFactory.RevealXDirection.RIGHT;
            }
        }
        ...
        if (bottomDiff != 0) {
            ...
            // Otherwise, align the top of the sheet with the top of the FAB
                ...
                revealYDirection = FabRevealFactory.RevealYDirection.DOWN;
            }
        }
    }
    ...
    protected void startCircularRevealAnim(View view, int centerX, int centerY, float startRadius,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            // Setup animation
            SupportAnimator anim = com.leoneves.maktaba.fabreveal.reveal.ViewAnimationUtils
    ...
    public int getSheetRevealCenterY(View fab) {
        if (revealYDirection == FabRevealFactory.RevealYDirection.UP) {
    ...
    public FabRevealFactory.RevealXDirection getRevealXDirection() {
        return revealXDirection;
    }

    public FabRevealFactory.RevealYDirection getRevealYDirection() {
