package com.leoneves.maktaba.fabreveal.widget;
...
import com.leoneves.maktaba.fabreveal.fabanimations.AnimationListener;
import com.leoneves.maktaba.fabreveal.fabanimations.FabAnimation;
import com.leoneves.maktaba.fabreveal.fabanimations.MaterialSheetAnimation;
import com.leoneves.maktaba.fabreveal.fabanimations.OverlayAnimation;
import com.leoneves.maktaba.fabreveal.fabanimations.Side;
 ...
 */
public class FabRevealFactory<FAB extends View & AnimatedFab> {
    ...
    private static final int SHOW_OVERLAY_ANIM_DURATION = FabRevealFactory.SHOW_SHEET_ANIM_DELAY
            + SHEET_ANIM_DURATION;
    ...
    // Listeners
    private FabRevealEventListener eventListener;
    ...
    /**
     * Creates a FabRevealFactory instance and sets up the necessary click listeners.
     *
     ...
     */
    public FabRevealFactory(FAB fab, View sheet, View overlay, int sheetColor, int fabColor) {
        ...
        fab.getViewTreeObserver()
                .addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        FabRevealFactory.this.fab.getViewTreeObserver()
