...
import com.leoneves.maktaba.dialog.storagechooser.adapters.SecondaryChooserAdapter;
...
import com.leoneves.maktaba.dialog.storagechooser.utils.ResourceUtil;
...
public class SecondaryChooserDialog {
    ...
    private void showAddFolderView() {
        ...
        Animation anim = AnimationUtils.loadAnimation(mContext, R.anim.dialog_anim_new_folder_view);
        mNewFolderView.startAnimation(anim);
        mInactiveGradient.startAnimation(anim);


            if (DiskUtil.isLollipopAndAbove()) {
                mNewFolderImageView.setImageDrawable(ContextCompat.getDrawable(mContext,R.drawable.dialog_drawable_plus_to_close));
...
//        mNewFolderButton.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.window_close));
    ...
    private void hideAddFolderView() {
        Animation anim = AnimationUtils.loadAnimation(mContext, R.anim.dialog_anim_close_folder_view);
        mNewFolderView.startAnimation(anim);
        mNewFolderView.setVisibility(View.INVISIBLE);

            if (DiskUtil.isLollipopAndAbove()) {
                mNewFolderImageView.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.dialog_drawable_close_to_plus));
                // image button animation
                Animatable animatable = (Animatable) mNewFolderImageView.getDrawable();
                animatable.start();
            }
...
//        mNewFolderButton.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.plus));
    ...
    private void playTheAddressBarAnimation() {
        ...
        Animation animation = AnimationUtils.loadAnimation(mContext, R.anim.dialog_anim_address_bar);
