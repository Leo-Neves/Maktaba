package com.leoneves.maktaba.dialog.storagechooser;
...
public class StorageChooserView {
    ...
    // LAYOUTS
    public static int VIEW_SC = R.layout.dialog_custom_storage_list;

    // layout choices
    public static int SC_LAYOUT_SLEEK = R.layout.dialog_custom_storage_list;
