...
import com.leoneves.maktaba.dialog.storagechooser.animators.MemorybarAnimation;
import com.leoneves.maktaba.dialog.storagechooser.exceptions.MemoryNotAccessibleException;
...
public class StorageChooserListAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View rootView = inflater.inflate(R.layout.dialog_row_storage, viewGroup, false);
