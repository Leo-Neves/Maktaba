...
import kotlinx.android.synthetic.main.filter_item_filter.view.*
...
class FilterItem : FrameLayout, Serializable {
    ...
    var startY: Float = 0f
    @ColorInt
    var cancelIconTint: Int = android.R.color.white
    @DrawableRes
    var cancelIcon: Int = R.drawable.filter_ic_cancel
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.filter_item_filter, this, true)
        ...
        buttonCancel.backgroundTintList = ColorStateList.valueOf(getColor(cancelIconTint))
        isIncreased = true
    }
