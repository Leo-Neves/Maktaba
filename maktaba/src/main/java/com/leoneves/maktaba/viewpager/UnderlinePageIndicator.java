...
public class UnderlinePageIndicator extends View implements PageIndicator {
    ...
    public UnderlinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        setFades(a.getBoolean(R.styleable.UnderlinePageIndicator_upi_fades, defaultFades));
        setSelectedColor(a.getColor(R.styleable.UnderlinePageIndicator_upi_selectedColor, defaultSelectedColor));
        setFadeDelay(a.getInteger(R.styleable.UnderlinePageIndicator_upi_fadeDelay, defaultFadeDelay));
        setFadeLength(a.getInteger(R.styleable.UnderlinePageIndicator_upi_fadeLength, defaultFadeLength));
